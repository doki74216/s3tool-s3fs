...
static int complete_multipart_upload(const char *path, string upload_id,
  ...
  postContent.clear();
  postContent.append("<CompleteMultipartUpload xmlns=\"http://s3.amazonaws.com/doc/2006-03-01/\">\n");
...
static void show_help (void) {
  ...
  printf( 
    "\n"
    "Mount an hicloud S3 bucket as a file system.\n"
    "\n"
    ...
    "\n"
    "   url (default=\"http://s3.hicloud.net.tw\")\n"
    "      - sets the url to use to access hicloud S3\n"
    "\n"
